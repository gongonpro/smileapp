...
class Conexion(
    ...
    private $contrasena = "";
    public $pdo = null;
    private $atributos = [PDO::ATTR_CASE=>PDO::_LOWER,PDO::ATTR_ERRMODE=>PDO::ERRMODE_EXCEPTION,PDO::ATTR_ORACLE_NULLS=>PDO::NULL_EMPTY_STRING,PDO::ATTR_DEFAULT_FETCH_MODE=>PDO::FETCH_OBJ];
